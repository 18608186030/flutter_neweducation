  ...
  Widget build(BuildContext context) {
    ...
    switch (state) {
      ...
      case LoadingState.empty:
        widget = LoadingViewEmpty(
            emptyRetryListener != null ? emptyRetryListener : allRetryListener);
        break;
      case LoadingState.error:
        widget = LoadingViewError(
            errorRetryListener != null ? errorRetryListener : allRetryListener);
        break;
      case LoadingState.netError:
        widget = LoadingViewIntentError(intentErrorRetryListener != null
